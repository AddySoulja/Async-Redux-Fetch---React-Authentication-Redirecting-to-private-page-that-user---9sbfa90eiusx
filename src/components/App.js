...
const API_KEY = "f886fe283692493fa381c4280b31f83d"; //Get your own api key from newsapi
...
const App = () => {
  ...
  useEffect(() => {
    fetch(
      "https://newsapi.org/v2/top-headlines?country=us&apiKey=f886fe283692493fa381c4280b31f83d"
    )
      .then((res) => res.json())
      .then((data) =>
